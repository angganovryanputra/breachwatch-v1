(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_eaa29063._.js", {
...
const DEFAULT_SETTINGS = {
    ...
    scheduleRunAtDate: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd'),
...
function DashboardPage() {
    _s();
    const [downloadedFiles, setDownloadedFiles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [currentJobFilter, setCurrentJobFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const fetchData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[fetchData]": async ()=>{
            ...
            try {
                if (jobIdFromQuery) {
                    try {
                        const jobDetails = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCrawlJob"])(jobIdFromQuery);
                ...
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDownloadedFiles"])(jobIdFromQuery || undefined, 0, 500);
                data.sort({
                    "DashboardPage.useCallback[fetchData]": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(b.date_found).getTime() - (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(a.date_found).getTime()
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDownloadedFileRecord"])(id, false);
            toast({
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[filteredData]": ()=>{
            return downloadedFiles.filter({
                "DashboardPage.useMemo[filteredData]": (item)=>{
                    ...
                    const keywordsMatch = item.keywords_found?.some({
                        "DashboardPage.useMemo[filteredData]": (kw)=>kw.toLowerCase().includes(searchTermLower)
                    }["DashboardPage.useMemo[filteredData]"]);
            ...
            }["DashboardPage.useMemo[filteredData]"]).filter({
                "DashboardPage.useMemo[filteredData]": (item)=>filterFileType === 'all' || item.file_type === filterFileType
            }["DashboardPage.useMemo[filteredData]"]);
        }
    }["DashboardPage.useMemo[filteredData]"], [
        downloadedFiles,
    ...
    const uniqueFileTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[uniqueFileTypes]": ()=>{
            const types = new Set(downloadedFiles.map({
                "DashboardPage.useMemo[uniqueFileTypes]": (item)=>item.file_type
            }["DashboardPage.useMemo[uniqueFileTypes]"]).filter(Boolean));
            ...
            const combinedTypes = new Set([
                ...
                ...allKnownTypes.filter({
                    "DashboardPage.useMemo[uniqueFileTypes]": (t)=>!types.has(t) && downloadedFiles.some({
                            "DashboardPage.useMemo[uniqueFileTypes]": (df)=>df.file_type && df.file_type.includes(t)
                        }["DashboardPage.useMemo[uniqueFileTypes]"])
                }["DashboardPage.useMemo[uniqueFileTypes]"])
            ]);
            return [
    ...
    const summaryStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[summaryStats]": ()=>{
            return {
...
_s(DashboardPage, "1Oc+aUmOrZSHEevD/ql5tnK6wV8=", false, function() {
    return [
...
//# sourceMappingURL=src_eaa29063._.js.map