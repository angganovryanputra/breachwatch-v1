(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_80222913._.js", {
...
async function apiRequest(path, method = 'GET', body, isAuthRequest = false // Flag to indicate if this is an auth-related request that doesn't need token for itself
) {
...
const loginUser = async (payload)=>{
    ...
    return apiRequest('/auth/login', 'POST', formData, true);
};
const registerUser = async (payload)=>{
    return apiRequest('/auth/register', 'POST', payload, true);
};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)"); // Import useRouter for redirects
;
...
const AuthProvider = ({ children })=>{
    ...
    const fetchAndSetUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[fetchAndSetUser]": async ()=>{
            const token = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('breachwatchAuthToken') : ("TURBOPACK unreachable", undefined);
            if (token) {
                try {
                    const currentUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentUser"])();
                    if (currentUser) {
                        setUser(currentUser);
                    } else {
    ...
    const login = async (email, password)=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])(payload);
    ...
    const signup = async (email, password, name)=>{
        ...
        try {
            ...
            const newUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerUser"])(payload);
...
_s(AuthProvider, "j9Ah16olRuM7AfJWCDexiDqGJq8=", false, function() {
    return [
...
//# sourceMappingURL=src_80222913._.js.map