...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)"); // Import useRouter for redirects
'use client';
;
;
;
...
const AuthProvider = ({ children })=>{
    ...
    const fetchAndSetUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
    ...
    const login = async (email, password)=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginUser"])(payload);
            if (response.access_token) {
                storeToken(response.access_token);
                // Fetch user details after successful login
                const currentUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentUser"])();
                setUser(currentUser);
            } else {
    ...
    const signup = async (email, password, name)=>{
        ...
        try {
            ...
            const newUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$breachwatch$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerUser"])(payload);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__749e5c00._.js.map