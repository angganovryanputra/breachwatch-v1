...
function DashboardPage() {
    const [breachData, setBreachData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Simulate API call
        setTimeout(()=>{
            setBreachData(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_BREACH_DATA"]);
            setIsLoading(false);
        }, 1000);
    }, []);
    const handleRefresh = ()=>{
        ...
        setTimeout(()=>{
            const newEntries = Array.from({
                length: 3
            }, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateNewMockEntry"]);
    ...
    const handleDownload = (item)=>{
        ...
        try {
            const existingDownloadsRaw = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DOWNLOADED_FILES_STORAGE_KEY"]);
            ...
            localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DOWNLOADED_FILES_STORAGE_KEY"], JSON.stringify(updatedDownloads));
            toast({
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return breachData.filter((item)=>{
            const searchTermLower = searchTerm.toLowerCase();
            return item.sourceUrl.toLowerCase().includes(searchTermLower) || item.fileUrl.toLowerCase().includes(searchTermLower) || item.keywords.some((kw)=>kw.toLowerCase().includes(searchTermLower));
        }).filter((item)=>filterFileType === 'all' || item.fileType === filterFileType).filter((item)=>filterStatus === 'all' || item.status === filterStatus);
    }, [
        breachData,
        searchTerm,
        filterFileType,
    ...
    const uniqueFileTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const types = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_BREACH_DATA"].map((item)=>item.fileType)); // Base on initial mock to keep consistent
        return [
            'all',
            ...Array.from(types)
        ];
    ...
    const uniqueStatuses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const statuses = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_BREACH_DATA"].map((item)=>item.status).filter(Boolean)); // Base on initial mock
        return [
            'all',
            ...Array.from(statuses)
        ];
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__cb3195b4._.js.map