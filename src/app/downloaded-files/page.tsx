...
export default function DownloadedFilesPage() {
  ...
  const handleOpenOriginalFile = (fileUrl: string) => {
     toast({
  ...
  }, [files, searchTerm, filterFileType]);
    ...
    return (
      <AppShell>
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <p className="ml-4 text-xl mt-4">Loading downloaded file records from backend...</p>
        </div>
      </AppShell>
    );
  }
        ...
        <CardHeader>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <CardDescription>
                List of files whose metadata has been recorded by the backend crawlers.
              </CardDescription>
            </div>
              ...
              <TableBody>
                {paginatedData.map((item) => (
                  <TableRow key={item.id} className="hover:bg-muted/50">
                    ...
                    <TableCell>
                     ...
                     <TableCell className="max-w-xs truncate">
                       <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <a href={item.source_url} target="_blank" rel="noopener noreferrer" className="hover:underline text-muted-foreground hover:text-accent/80">
                              {item.source_url}
                            </a>
                          </TooltipTrigger>
                          <TooltipContent side="bottom" className="max-w-md">
                    ...
                    <TableCell>{format(parseISO(item.date_found), 'MMM dd, yy HH:mm')}</TableCell>
                    ...
                    <TableCell className="text-right">
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                             <Button variant="ghost" size="icon" onClick={() => handleOpenOriginalFile(item.file_url)}>
