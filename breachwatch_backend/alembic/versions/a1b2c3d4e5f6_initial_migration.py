...
def upgrade() -> None:
    ...
    sa.Column('settings_custom_user_agent', sa.String(), nullable=True),
    sa.Column('settings_schedule_type', sa.String(), nullable=True),
    sa.Column('settings_schedule_cron_expression', sa.String(), nullable=True),
    sa.Column('settings_schedule_run_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('settings_schedule_timezone', sa.String(), nullable=True),
